...
export default function PlusMinus({ num, setNum }) {
    return (
        <View style={{ width: '45%', height: '90%', justifyContent: 'space-evenly', alignItems: 'center', backgroundColor: '#192a56', borderRadius: 10, flexDirection: 'row' }}>
            <TouchableOpacity onPress={() => setNum(num+1)} activeOpacity={0.7} style={{ width: width * .09, height: width * .09, borderWidth: 1, borderColor: '#00e9bf', borderRadius: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
